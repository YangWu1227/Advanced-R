...
The base type of object `x` is "closure". The object is of the class ecdf (empirical cumulative distribution function) with the super-classes are "stepfun" and are "function". It also has a `call` attribute, which stores the function expression. 
...
# The element "4" occurred 16 times
vector[vector == 4]
vector[vector == 4] %>% length()
# The element "9" occurred 5 times
vector[vector == 9]
